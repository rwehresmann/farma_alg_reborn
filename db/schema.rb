...
ActiveRecord::Schema.define(version: 20170702131839) do
  ...
  create_table "answers_recommendations", force: :cascade do |t|
    t.integer "answer_id"
    t.integer "recommendation_id"
    t.index ["answer_id"], name: "index_answers_recommendations_on_answer_id", using: :btree
    t.index ["recommendation_id"], name: "index_answers_recommendations_on_recommendation_id", using: :btree
  end
